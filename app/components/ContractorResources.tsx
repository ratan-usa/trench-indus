...
const RESOURCES = [
  {
    ...
    imageSrc: '/paving/paving riser rectangle iron.668.png', // Replace with an active paving/roadwork jobsite
    href: '#safety'
  },
  {
    id: 'installation',
    ...
    imageSrc: '/paving/paving riser 1.641.png', // Replace with an active paving/roadwork jobsite
    href: '#installation'
  },
  {
    id: 'case-studies',
    ...
    imageSrc: '/paving/D shape Riser Raw Finish.602.png', // Replace with an active paving/roadwork jobsite
    href: '#case-studies'
  }
];
