...
const FEATURES = [
    {
        ...
        icon: <Truck className="w-8 h-8 text-[#cc2221]" />,
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        {FEATURES.map((feature, idx) => (
                            <div key={idx} className="flex flex-col items-center text-center group">
                                <div className="p-5 bg-white rounded-none shadow-[10px_10px_0px_rgba(0,0,0,0.05)] border border-gray-100 group-hover:border-[#cc2221] group-hover:shadow-[10px_10px_0px_rgba(204,34,33,0.1)] transition-all duration-500 mb-8">
                                    {feature.icon}
                                </div>
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <Link href="/assets/catalog/MEGA-PAVING-RISERS-CATALOGS.pdf">
                            <Button size="lg" className="bg-[#cc2221] hover:bg-white hover:text-black text-white text-sm px-10 py-8 font-black uppercase tracking-[0.2em] rounded-none transition-all duration-300">
                                <Download className="mr-2 w-5 h-5" /> Download Catalog
                            </Button>
                        </Link>
                        <Link href="#our-product">
                            <Button size="lg" variant="outline" className="border-4 border-white text-white hover:bg-[#cc2221] hover:border-[#cc2221] text-sm px-10 py-8 font-black uppercase tracking-[0.2em] rounded-none transition-all duration-300 bg-transparent">
