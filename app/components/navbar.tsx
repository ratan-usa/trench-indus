...
const Navbar = () => {
    return (
        <div>
            ...
            <header className="bg-white border-b-[4px] border-[#c92526] sticky top-0 z-50 shadow-sm">
                <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex gap-8 text-sm font-bold uppercase tracking-wider text-gray-700">
                        <a href="#products" className="hover:text-[#c92526] transition-colors">Products</a>
                        <a href="#innovation" className="hover:text-[#c92526] transition-colors">Innovation</a>
                        <a href="#library" className="hover:text-[#c92526] transition-colors">Library</a>
