    ...
    <section className="bg-gray-50 font-sans">
      <div className="p-6 md:p-8 lg:p-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
          ...
          <Link 
            href="/pro-service" 
            className="text-[#C92027] font-medium hover:underline transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {SERVICES_DATA.map((card) => (
            <div 
              key={card.id} 
              className="relative bg-[#C92027] rounded-md overflow-hidden flex flex-col p-8 md:p-10 min-h-[320px] group shadow-sm hover:shadow-md transition-shadow"
            >
