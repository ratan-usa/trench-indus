        ...
        <div className="w-full px-6 md:px-8 lg:px-12 mx-auto">
          <div className="flex justify-between items-center h-9">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              {/* --- LANGUAGE DROPDOWN --- */}
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center justify-center gap-1.5 text-xs hover:text-[#CC0000] transition-colors outline-none">
          ...
          <div className="lg:hidden bg-neutral-900 border-t border-neutral-700 absolute w-full left-0 top-9 shadow-xl py-4 px-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-4 justify-start mt-2">
                <Link href={'/'}><Linkedin className='w-4 h-4 hover:text-[#CC0000]' /></Link>
                <Link href={'/'}><Facebook className='w-4 h-4 hover:text-[#CC0000]' /></Link>
                <Link href={'/'}><Instagram className='w-4 h-4 hover:text-[#CC0000]' /></Link>
                <Link href={'/'}><Twitter className='w-4 h-4 hover:text-[#CC0000]' /></Link>
              </div>
            </div>
          </div>
        )}
