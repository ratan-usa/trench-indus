  ...
  return (
    <section className="bg-white w-full  font-sans border-t border-gray-100">
      <div className="p-6 md:p-8 lg:p-12">
        ...
        {/* --- HEADER --- */}
        <h2 className="text-3xl md:text-4xl font-black text-[#c92526] uppercase tracking-tight mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {RESOURCES.map((resource) => (
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 z-10 flex items-center text-[#c92526] font-black uppercase tracking-widest text-sm group-hover:text-white transition-colors duration-300">
                {resource.type === 'video' ? (
                  <>
