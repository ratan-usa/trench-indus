        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative z-10 aspect-square w-full rounded-2xl overflow-hidden border border-slate-100 shadow-2xl">
              ...
              />
              {/* Overlay Badge */}
              <div className="absolute top-6 left-6 bg-[#c92526] text-white px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest">
            ...
            <div className="absolute top-1/2 -left-8 -translate-y-1/2 p-6 bg-white shadow-xl rounded-xl border border-slate-50 hidden md:block">
              <div className="flex items-center gap-4 text-[#c92526]">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h4 className="text-[#c92526] font-bold text-sm uppercase tracking-[0.2em]">Municipal Solutions</h4>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 leading-tight">
                Cast Iron <br /> <span className="text-[#c92526]">Paving Risers</span>
              </h2>
