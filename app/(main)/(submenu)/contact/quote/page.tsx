          ...
          <div className="xl:w-1/3 w-full sticky top-32 space-y-8">
            ...
            <div className="w-full aspect-square bg-[#0A0A0A] border border-white/10 relative overflow-hidden group">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10 p-8">
                <Image 
                  src={
                    selectedProduct === 'catch-basin' ? "/paving/Rectangle Paving Riser 1.619.png" : 
                    selectedProduct === 'valve-box' ? "/paving/Sqaure Riser Coated Finish.611.png" : 
                    "/paving/paving riser 1 ductile iron.653.png"
                  }
