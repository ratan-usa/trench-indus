...
const SECTIONS = [
  {
    ...
    media: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/Videos/1_to_23.2400.mp4`,
    isVideo: true,
  },
  {
    id: 'high-flow',
    ...
    icon: Waves,
    media: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/Skype_Picture_2024_12_27T12_12_04_319Z.jpeg`,
    isVideo: false,
  },
  {
    id: 'custom-fab',
    ...
    icon: Wrench,
    media: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/Videos/10-36_NEW_GRATE_ANIAMTION_normal.5110.mp4`,
    isVideo: true,
  }
];
