...
const TOOLS = [
  ...
  },
  {
    ...
    desc: 'High-torque wrench specifically calibrated for expanding the Mechanical Expansions on our adjustable grates.',
    icon: Wrench,
  ...
  },
  {
    ...
    desc: 'Industrial magnetic lifting tool to easily lower and align heavy cast iron grates into place before trenching.',
    icon: Hammer,
  ...
  },
  {
    ...
    name: 'Pry Bar',
    title: 'Alignment Bar',
    desc: 'Solid steel pry bar for making micro-adjustments to the seating of grates in older, irregular frames.',
    icon: ShieldAlert,
  ...
  },
  {
    ...
    desc: 'Heavy-duty steel guide pins used to precisely align multi-part trench covers and grates during final assembly.',
    icon: Wrench,
  ...
  },
  {
    ...
    name: 'Lifting Tongs',
    title: 'Cover Tongs',
    desc: 'Heavy-duty lifting tongs to provide a secure grip on flat trench covers and solid grates during extraction.',
    icon: ShieldAlert,
