...
const FINISHES = [
  { name: 'Raw Finish', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/paving/Round%20Riser%20with%20screw%20Raw%20Finish.617.png`, desc: 'Industrial standard for general municipal applications.' },
  { name: 'Black Coated', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/paving/Round%20Riser%20with%20screw%20coated%20Finish.618.png`, desc: 'Resists corrosion from road salt and extreme weather.' },
  { name: 'Iron Foundry', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/paving/Round%20Riser%20with%20screw%20iron%20Finish.615.png`, desc: 'Heavy-duty foundry cast finish for ultimate durability.' },
];
