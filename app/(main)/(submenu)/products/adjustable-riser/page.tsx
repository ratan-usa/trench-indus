...
const FINISHES = [
  { name: 'Raw Finish', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/Manhole_riser/Round_Riser_with_screw_Raw_Finish.617.png`, desc: 'Industrial standard for general municipal applications.' },
  { name: 'Black Coated', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/Manhole_riser/Adjustbale_riser_coated_finish.808.png`, desc: 'Resists corrosion from road salt and extreme weather.' },
  { name: 'Iron Foundry', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/Manhole_riser/Round_Riser_with_screw_iron_Finish.615.png`, desc: 'Heavy-duty foundry cast finish for ultimate durability.' },
];
