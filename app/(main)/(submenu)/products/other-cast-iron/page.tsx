...
const CAST_IRON_PRODUCTS = [
  {
    ...
    image: '/paving/Rectangle Paving Riser 1.619.png',
  },
  {
  ...
  },
  {
    ...
    image: '/paving/paving riser Square ductile iron.663.png',
  },
  {
    title: 'D-Shape Inlet Frames',
    category: 'Curb Inlets',
    description: 'Custom molded D-shape frames that match existing curb lines perfectly for seamless water flow.',
    image: '/paving/paving riser 3 raw iron.646.png',
  }
];
