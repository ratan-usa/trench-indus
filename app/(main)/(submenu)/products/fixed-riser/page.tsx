...
const FINISHES = [
  { id: 'F01', name: 'Raw Cast Iron', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/trench-grate-horizontal-view_(12).jpeg`, desc: 'Industrial grade raw iron for immediate use.' },
  { id: 'F02', name: 'Coated Finish', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/trench-grates-img-diagonal-view_(5).jpeg`, desc: 'Black coated to resist extreme environmental corrosion.' },
  { id: 'F03', name: 'Standard Iron', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/trench-grates-img-diagonal-view_(8).jpeg`, desc: 'Standard foundry casting for maximum shock load.' },
  { id: 'F04', name: 'Ductile Alloy', image: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/TRENCH_GRATES_001_(4).jpeg`, desc: 'High flexibility ductile iron to prevent sudden cracking.' },
];
