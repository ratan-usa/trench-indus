        ...
        <section className="mb-40">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative aspect-square bg-[#0A0A0A] overflow-hidden border border-white/5 group">
              ...
              >
                <source src={`/Videos/Videos/1.751.mp4`} type="video/mp4" />
              </video>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-square bg-[#0A0A0A] overflow-hidden border border-white/5 group">
              <video autoPlay loop muted playsInline  
                ...
                className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-100 group-hover:scale-105 transition-all duration-1000"
              >
                <source src={`/Videos/Videos/paving_riser_solid_ring_utilisation_animation.686.mp4`} type="video/mp4" />
              </video>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0A0A0A] border border-white/5 group hover:border-[#CC0000] transition-colors relative overflow-hidden flex flex-col h-[450px]">
              <div className="relative h-64 w-full">
                <Image src={`/images/Custom_Riser/D_shape_Riser_with_Steel.634.png`} alt="Engineering Spec" fill className="object-cover opacity-40 group-hover:opacity-80 transition-opacity duration-700" />
            ...
            <div className="bg-[#0A0A0A] border border-white/5 group hover:border-[#CC0000] transition-colors relative overflow-hidden flex flex-col h-[450px]">
              <div className="relative h-64 w-full">
                <Image src={`/images/catch_basin_riser/Square_riser_coated_finish.807.png`} alt="Engineering Spec" fill className="object-cover opacity-40 group-hover:opacity-80 transition-opacity duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] to-transparent" />
              </div>
              <div className="p-8 flex-1 flex flex-col justify-end -mt-16 relative z-10">
            ...
            <div className="bg-[#0A0A0A] border border-white/5 group hover:border-[#CC0000] transition-colors relative overflow-hidden flex flex-col h-[450px]">
              <div className="relative h-64 w-full">
                <Image src={`/images/Valve_box_riser/5.358.jpg.jpeg`} alt="Engineering Spec" fill className="object-cover opacity-40 group-hover:opacity-80 transition-opacity duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] to-transparent" />
              </div>
              <div className="p-8 flex-1 flex flex-col justify-end -mt-16 relative z-10">
