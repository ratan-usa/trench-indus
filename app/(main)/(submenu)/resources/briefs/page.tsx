          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0A0A0A] border border-white/5 group hover:border-[#CC0000] transition-colors relative overflow-hidden flex flex-col h-[450px]">
              <div className="relative h-64 w-full">
                <Image src={`${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/pre-trench-04.jpg`} alt="Engineering Spec" fill className="object-cover opacity-40 group-hover:opacity-80 transition-opacity duration-700" />
            ...
            <div className="bg-[#0A0A0A] border border-white/5 group hover:border-[#CC0000] transition-colors relative overflow-hidden flex flex-col h-[450px]">
              <div className="relative h-64 w-full">
                <Image src={`${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/TI-006.JPG`} alt="Engineering Spec" fill className="object-cover opacity-40 group-hover:opacity-80 transition-opacity duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] to-transparent" />
              </div>
              <div className="p-8 flex-1 flex flex-col justify-end -mt-16 relative z-10">
            ...
            <div className="bg-[#0A0A0A] border border-white/5 group hover:border-[#CC0000] transition-colors relative overflow-hidden flex flex-col h-[450px]">
              <div className="relative h-64 w-full">
                <Image src={`${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/images/trench-grate-horizontal-view_(12).jpeg`} alt="Engineering Spec" fill className="object-cover opacity-40 group-hover:opacity-80 transition-opacity duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] to-transparent" />
              </div>
              <div className="p-8 flex-1 flex flex-col justify-end -mt-16 relative z-10">
