...
export default function IndustrySolutionsBanner() {
  return (
    <section className="w-full font-sans border-b border-gray-200">
      ...
      <div className="bg-[#CC0000] text-white flex flex-col md:flex-row items-stretch relative overflow-hidden">
      ...
      <div className="bg-gray-50">
        <div className="p-6 md:p-8 lg:p-12">
          <div className="max-w-4xl">
            ...
            <a
              href="#contact"
              className="inline-flex items-center text-[#CC0000] font-bold uppercase tracking-wider hover:text-black transition-colors group"
            >
