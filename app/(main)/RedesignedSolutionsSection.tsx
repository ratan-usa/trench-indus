...
const TABS = [
  {
    ...
    // videoUrl: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/video/PR%20Manufacturing%20Video.mp4` 
    videoUrl: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/video/C24A_11_options.mp4`
  ...
  },
  {
    ...
    videoUrl: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/video/Catch%20basin%20riser%20ayush.718.mp4`
  },
  {
    id: 'driveways',
  ...
  },
  {
    ...
    videoUrl: `${process.env.NEXT_PUBLIC_R2_BUCKET_URL}/video/paving_riser_solid_ring_utilisation_animation_676.mp4`
  },
];
