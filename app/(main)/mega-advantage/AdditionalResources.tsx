            ...
            <div className="p-6 md:p-8 lg:p-12">
                ...
                <div>
                    ...
                    <div className="relative flex items-center">
                        ...
                        <button className="hidden md:flex absolute -left-12 w-10 h-10 border border-gray-300 items-center justify-center text-[#cc2221] hover:border-[#cc2221] hover:bg-red-50 transition-colors z-10 bg-white">
                        ...
                        <button className="hidden md:flex absolute -right-12 w-10 h-10 border border-[#cc2221] items-center justify-center text-[#cc2221] hover:bg-red-50 transition-colors z-10 bg-white">
