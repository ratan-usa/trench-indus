  ...
  return (
    <div className="font-sans">
      ...
      <section className="w-full">
        ...
        <div className="bg-[#CC0000] text-white flex flex-col md:flex-row items-stretch">
          ...
          <div className="relative w-full md:w-1/3 min-h-[200px] md:min-h-full hidden md:block">
            <Image
              src={`/assets/trenching-RISERS/d-shape.png`} // Replace with a shot of workers installing a grate
              alt="Contractors installing a trench grate"
              fill
              className="object-cover opacity-60 mix-blend-multiply grayscale"
            />
            {/* Gradient fade to blend image with the red background */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#CC0000] via-[#CC0000] to-transparent"></div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 border-b border-gray-200">
          <div className="container mx-auto p-6 md:p-8 lg:p-12">
            <div className="max-w-4xl">
              ...
              <a href="#contact" className="inline-flex items-center text-[#CC0000] font-black uppercase tracking-wider hover:text-black transition-colors">
