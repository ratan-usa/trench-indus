      ...
      <div className="p-6 md:p-8 lg:p-12">
        ...
        <div className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
            How Mega Paving Risers supports your crew
          </h2>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-stretch gap-8 lg:gap-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            ...
            <a
              ...
              className="inline-flex items-center text-[#c92526] font-bold hover:text-black transition-colors group"
            >
          ...
          <div className="w-full md:w-1/2">
            <div className="relative w-full h-64 md:h-full min-h-[350px] overflow-hidden rounded-sm shadow-sm border border-gray-100">
              ...
              <Image
                src="/assets/PAVING-RISERS/paving riser 1.5200.png"
